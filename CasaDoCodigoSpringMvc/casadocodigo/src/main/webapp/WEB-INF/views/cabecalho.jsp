			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						...
						<li><a href="${s:mvcUrl('PC#listar').build() }" rel="nofollow"><s:message code="menu.lista"/></a></li>
    					
    					<li><a href="${s:mvcUrl('PC#form').build() }" rel="nofollow"><s:message code="menu.cadastro"/></a></li>
